...
const handleChange = (e) => {
  ...
  return (
    <Container maxWidth="md" sx={{ paddingTop: '3rem', paddingBottom: '3rem' }}>
      <Paper sx={{ p: 4, borderRadius: 2, boxShadow: '0 4px 16px rgba(0, 0, 0, 0.1)', background: '#f9f9f9' }}>
        <Typography variant="h5" component="h1" gutterBottom sx={{ fontWeight: 600, color: '#333' }}>
          Add New Product
        </Typography>
        <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          <TextField
            ...
            margin="normal"
            required
            sx={{ backgroundColor: 'white', borderRadius: 1, '& .MuiOutlinedInput-root': { borderRadius: '8px' }}}
          />
          <TextField
            fullWidth
            label="Description"
